...
/*        int oneLength = wordListOne.length;
        ...
        String phrase = wordListOne[(int) (Math.random() * wordListOne.length)] + " "
                + wordListTwo[(int) (Math.random() * wordListTwo.length)] + " "
                + wordListThree[(int) (Math.random() * wordListThree.length)];
